...
namespace H5Net.Api
{
    public class MOS100MI
    {
        ...
        public static Dictionary<string, string> HeaderToFieldMap()
        {
            ...
            PropertyInfo[] props = typeof(MOS100MI).GetProperties();
        ...
        public static void AddMtrl()
        {
            FieldToColumnMap.ProcessHeader(new MOS100MI(), new string[] { "Work_order_number", "Component_number", "Quantity", "Operation_number", "Reservation_date" });
