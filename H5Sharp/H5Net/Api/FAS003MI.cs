...
namespace H5Net.Api
{
    public class FAS003MI
    {
        ...
        [FieldAttribute("VATP", true)]
        public string Value_type { get; set; }

        [FieldAttribute("FAVC", true)]
        public string Fixed_asset_value_currency { get; set; }

        [FieldAttribute("AIT1", false)]
        public string Accounting_dimension_1 { get; set; }
        ...
        public static Dictionary<string, string> HeaderToFieldMap()
        {
            ...
            PropertyInfo[] props = typeof(FAS003MI).GetProperties();
        ...
        //public static void CrtStdValueType()
        //{
        ...
        public static void CrtStdValueType()
        {
            FieldToColumnMap.ProcessHeader(new FAS003MI(), new string[] { "Division", "Fixed_asset", "Subnumber" });
        ...
        //{
        //    string[] cols = { "Division", "Fixed_asset", "Subnumber", "Value_type", "Fixed_asset_value_currency",
        //                      "Value_period", "Accounting_dimension_2", "Accounting_dimension_2",
        //                      "Accounting_dimension_4"};
        ...
        public static void Upd()
        {
            FieldToColumnMap.ProcessHeader(new FAS003MI(), new string[] { "Division", "Fixed_asset", "Subnumber", "Value_type", "Fixed_asset_value_currency",
                              "Value_period", "Accounting_dimension_1", "Accounting_dimension_2",
                              "Accounting_dimension_4","Accounting_dimension_6"});

            #region Revist after implementing IDisposable
            ...
            #endregion Revist after implementing IDisposable
        }
