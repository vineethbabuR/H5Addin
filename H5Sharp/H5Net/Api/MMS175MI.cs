...
namespace H5Net.Api
{
    public class MMS175MI
    {
        ...
        [FieldAttribute("TWSL", true)]
        public string To_location { get; set; }

        [FieldAttribute("TRQT", true)]
        public string Transaction_quantity_basic_UM { get; set; }
        ...
        [FieldAttribute("CAMU", false)]
        public string Container { get; set; }

        [FieldAttribute("WROU", false)]
        public string Print { get; set; }

        [FieldAttribute("DSP1", false)]
        ...
        public static Dictionary<string, string> HeaderToFieldMap()
        {
            ...
            PropertyInfo[] props = typeof(MMS175MI).GetProperties();
        ...
        {
            FieldToColumnMap.ProcessHeader(new MMS175MI(), new string[] { "Warehouse", "Item_number", "Lot_number", "Location", "Transaction_quantity_basic_UM", "To_location" });
