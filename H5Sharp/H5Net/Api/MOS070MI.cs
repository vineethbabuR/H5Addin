...
namespace H5Net.Api
{
    public class MOS070MI
    {
        [FieldAttribute("MWNO", true)]
        public string Work_order_number { get; set; }

        [FieldAttribute("OPNO", true)]
        public string Operation_number { get; set; }

        [FieldAttribute("RPDT", false)]
        public string Reporting_date { get; set; }

        [FieldAttribute("RPRE", false)]
        public string Resp_for_reporting { get; set; }

        [FieldAttribute("EMNO", true)]
        public string Employee_number { get; set; }

        [FieldAttribute("FCLA", false)]
        public string Failure_class { get; set; }

        [FieldAttribute("FCL2", false)]
        public string Error_code_2 { get; set; }

        [FieldAttribute("FCL3", false)]
        public string Error_code_3 { get; set; }

        [FieldAttribute("TXL1", false)]
        public string Text_1 { get; set; }

        [FieldAttribute("TXL2", false)]
        public string Text_2 { get; set; }

        [FieldAttribute("EQNO", false)]
        public string Equipment_number { get; set; }

        [FieldAttribute("REMK", false)]
        public string Remark { get; set; }

        [FieldAttribute("PCTP", true)]
        public string Costing_Type { get; set; }

        [FieldAttribute("UMAT", true)]
        public string Used_Labour_Run_Time { get; set; }
        ...
        public static Dictionary<string, string> HeaderToFieldMap()
        {
            ...
            PropertyInfo[] props = typeof(MOS070MI).GetProperties();
        ...
        public static void UpdOperation()
        {
            FieldToColumnMap.ProcessHeader(new MOS070MI(), new string[] { "Work_order_number","Operation_number","Reporting_date",
                                            "Employee_number","Costing_Type","Used_Labour_Run_Time" });
