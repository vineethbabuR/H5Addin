...
namespace H5Net.Api
{
    public class PPS205MI
    {
        [FieldAttribute("PUNO", true)]
        public string Purchase_order_number { get; set; }

        [FieldAttribute("RESP", true)]
        public string Responsible { get; set; }

        [FieldAttribute("REMK", true)]
        public string Remark { get; set; }

        [FieldAttribute("FUDX", true)]
        public string Monitoring_date { get; set; }

        [FieldAttribute("PNLI", false)]
        public string Purchase_order_line { get; set; }

        [FieldAttribute("PNLS", false)]
        public string Purchase_order_line_subnumber { get; set; }

        [FieldAttribute("FDAY", false)]
        public string Monitoring_lead_time { get; set; }

        [FieldAttribute("FUPF", false)]
        public string Monitoring_performed { get; set; }
        ...
        public static Dictionary<string, string> HeaderToFieldMap()
        {
            ...
            PropertyInfo[] props = typeof(PPS205MI).GetProperties();
        ...
        {
            FieldToColumnMap.ProcessHeader(new PPS205MI(), new string[] { "Purchase_order_number", "Responsible", "Remark", "Monitoring_date" });
        ...
        public static void DltMonitor()
        {
            FieldToColumnMap.ProcessHeader(new PPS205MI(), new string[] { "Purchase_order_number", "Monitoring_date" });
        }

        //TODO: Seem to have an incorrect response field is returned (PNLI), but works in general
        public static void UpdMonitor()
        {
            FieldToColumnMap.ProcessHeader(new PPS205MI(), new string[] { "Purchase_order_number", "Monitoring_date", "Remark", "Responsible" });
        }
