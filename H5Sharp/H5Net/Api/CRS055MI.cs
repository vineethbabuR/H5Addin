...
namespace H5Net.Api
{
    public class CRS055MI
    {
        [FieldAttribute("CUCD", true)]
        public string Currency { get; set; }

        [FieldAttribute("CRTP", true)]
        public string ExchangeRateType { get; set; }

        [FieldAttribute("CUTD", true)]
        ...
        public static void AddRate()
        {
            FieldToColumnMap.ProcessHeader(new CRS055MI(), new string[] { "Currency", "ExchangeRateType", "RateDate", "ExchangeRate", "Division" });
